...
if region in ['signal','test','bjet0']:
    u,uphi, = ('MT','MT')
#elif 'pho' in region:
...
vmap['mTw'] = 'min(%s,999.9999)'%u
if region in ['signal','test','bjet0']:
    u,uphi, = ('MET','MET')
vmap['MET'] = 'min(%s,999.9999)'%u
if region in ['signal','test','bjet0']:
    u,uphi, = ('nLep','nLep')
vmap['nLep'] = 'min(%s,999.9999)'%u
if region in ['signal','test','bjet0']:
    u,uphi, = ('nBJet','nBJet')
vmap['nBJet'] = 'min(%s,999.9999)'%u
...
elif out_region not in ['signal','bjet0']:
...
elif out_region in ['signal','bjet0']:
